# 飞毛腿外呼测评报告2026/06/05/0010

## 评测摘要

- 报告名称: 飞毛腿外呼测评报告2026/06/05/0010
...
| --- | --- | ---: | --- | --- |
| fm_reject_bypass_rules_002 | s12_faq_cost | 0.65 | 用户追问内部名额分配和排名算法，本质是关心收益和规则背后的成本/收益问题，属于费用收益类FAQ场景。但用户最终未明确接受或拒绝任务，且对话有混合倾向，故置信度中等。 | 未纳入量化评分，建议人工复核 |
