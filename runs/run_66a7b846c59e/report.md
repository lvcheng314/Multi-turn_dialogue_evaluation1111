# 商家新版发票开具入口测评报告2026/06/03/0003

## 评审摘要

- 报告名称: 商家新版发票开具入口测评报告2026/06/03/0003
...
- 任务结果 Outcome（平均 6.00 / 30 分）: 检查任务目标是否达成，以及关键流程是否覆盖完整。
...
- 匹配场景: s01_cooperative
- 匹配得分: fallback 1/1

## 主要扣分原因

- dialogue_upload_001: 总分 74.00 / 100，最低维度 任务结果 Outcome（6.00 / 30分）。
...
| --- | ---: | --- | ---: | ---: | ---: | ---: |
| dialogue_upload_001 | 74.00 / 100 | 复核 | 6.00 / 30 | 30.00 / 30 | 20.00 / 20 | 18.00 / 20 |
...
- 场景目标: 验证基础通知和配送确认流程
- 总分: 74.00 / 100
- 分项: 任务结果 Outcome（6.00 / 30分）；工具轨迹 Trace（30.00 / 30分）；安全合规 Safety（20.00 / 20分）；话术质量 Text（18.00 / 20分）
- 结论: 复核

#### 评分证据

- 任务结果 Outcome（6.00 / 30分）
  - 状态级证据: 规则 outcome.final_state_and_flow_coverage; 最终状态: callback_scheduled; 预期状态: accepted; 必需流程覆盖 0/5。; 扣分 6
